...
export default function LoginView() {
  ...
  return (
    <section className="text-bg-gray-900 bg-white w-screen min-h-screen h-full flex flex-col items-center justify-center gap-4">
      <div className="flex flex-col justify-center items-center min-w-1/5">
        <h1 className="text-2xl font-bold">생산이력 모니터링</h1>
        <p className="text-sm">기계 별 생산이력관리</p>
      </div>
